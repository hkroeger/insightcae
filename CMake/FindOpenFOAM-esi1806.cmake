...
overset
  ...
  set(OFesi1806_INSIGHT_INSTALL_BIN "bin/${OFesi1806_WM_PROJECT}-${OFesi1806_WM_PROJECT_VERSION}")
  set(OFesi1806_INSIGHT_INSTALL_LIB "lib/${OFesi1806_WM_PROJECT}-${OFesi1806_WM_PROJECT_VERSION}")
  set(OFesi1806_INSIGHT_BIN "${CMAKE_BINARY_DIR}/${OFesi1806_INSIGHT_INSTALL_BIN}")
  set(OFesi1806_INSIGHT_LIB "${CMAKE_BINARY_DIR}/${OFesi1806_INSIGHT_INSTALL_LIB}")
  ...
  macro (setup_exe_target_OFesi1806 targetname sources exename includes)
    ...
    install(TARGETS ${targetname} RUNTIME DESTINATION ${OFesi1806_INSIGHT_INSTALL_BIN} COMPONENT ${INSIGHT_INSTALL_COMPONENT})
  ...
  macro (setup_lib_target_OFesi1806 targetname sources exename includes)
    ...
    install(TARGETS ${targetname} LIBRARY DESTINATION ${OFesi1806_INSIGHT_INSTALL_LIB} COMPONENT ${INSIGHT_INSTALL_COMPONENT})
