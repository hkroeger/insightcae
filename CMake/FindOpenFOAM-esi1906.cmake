...
IF(OFesi1906_BASHRC)
  ...
  filterWarningFlags(OFesi1906_c++FLAGS)

  set(OFesi1906_CXX_FLAGS "${OFesi1906_c++FLAGS} -DOFesi1906 -DOF_VERSION=060500 -DOF_FORK_esi")
  set(OFesi1906_LIBSRC_DIR "${OFesi1906_DIR}/src")
  set(OFesi1906_LIB_DIR "${OFesi1906_DIR}/platforms/${OFesi1906_WM_OPTIONS}/lib")

  string(REGEX REPLACE "^[^ ]+" "" OFesi1906_LINKLIBSO ${OFesi1906_LINKLIBSO})
  string(REGEX REPLACE "^[^ ]+" "" OFesi1906_LINKEXE ${OFesi1906_LINKEXE})
...
overset
  ...
  macro (setup_lib_target_OFesi1906 targetname sources exename includes)
    ...
    SET(LIB_SEARCHFLAGS "-L${OFesi1906_LIB_DIR} -L${OFesi1906_LIB_DIR}/${OFesi1906_FOAM_MPI} -L${OFesi1906_FOAM_EXT_LIBBIN} -L${OFesi1906_SCOTCH_ROOT}/lib")
