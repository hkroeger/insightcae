...
IF(OF301_BASHRC)
  ...
  filterWarningFlags(OF301_c++FLAGS)
  set(OF301_CXX_FLAGS "${OF301_c++FLAGS} -DOF301 -DOF_VERSION=030001 -DOF_FORK_vanilla")
  set(OF301_LIBSRC_DIR "${OF301_DIR}/src")
  set(OF301_LIB_DIR "${OF301_DIR}/platforms/${OF301_WM_OPTIONS}/lib")
  
  string(REGEX REPLACE "^[^ ]+" "" OF301_LINKLIBSO ${OF301_LINKLIBSO})
  string(REGEX REPLACE "^[^ ]+" "" OF301_LINKEXE ${OF301_LINKEXE})
...
genericPatchFields
  ...
  macro (setup_lib_target_OF301 targetname sources exename includes)
    ...
    SET(LIB_SEARCHFLAGS "-L${OF301_LIB_DIR} -L${OF301_LIB_DIR}/${OF301_FOAM_MPI} -L${OF301_FOAM_EXT_LIBBIN} -L${OF301_SCOTCH_ROOT}/lib")
