...
IF(Fx40_BASHRC)
  ...
  filterWarningFlags(Fx40_c++FLAGS)

  set(Fx40_CXX_FLAGS "${Fx40_c++FLAGS} -DFx40 -DOF16ext -DOF_VERSION=010603 -DOF_FORK_extend")
  set(Fx40_LIBSRC_DIR "${Fx40_DIR}/src")
  set(Fx40_LIB_DIR "${Fx40_DIR}/platforms/${Fx40_WM_OPTIONS}/lib")
  
  string(REGEX REPLACE "^[^ ]+" "" Fx40_LINKLIBSO ${Fx40_LINKLIBSO})
  string(REGEX REPLACE "^[^ ]+" "" Fx40_LINKEXE ${Fx40_LINKEXE})
