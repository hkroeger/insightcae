...
IF(OF16ext_DIR)
  ...
  macro (setup_target_OF16ext targetname exename)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${OF16ext_CXX_FLAGS}")
    set(LINK_FLAGS "${LINK_FLAGS} ${OF16ext_LINKEXE}")
    link_directories(${OF16ext_LIB_DIR} ${OF16ext_FOAM_MPI_LIBBIN} ${OF16ext_METIS_LIB_DIR} ${OF16ext_PARMETIS_LIB_DIR} ${OF16ext_SCOTCH_LIB_DIR})
