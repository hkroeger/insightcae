...
FIND_FILE(OF24x_BASHRC NAMES etc/bashrc
  HINTS
  $ENV{HOME}/OpenFOAM/OpenFOAM-2.4.x
  $ENV{HOME}/OpenFOAM/OpenFOAM-2.4.0
...
IF(OF24x_BASHRC)
  ...
  filterWarningFlags(OF24x_c++FLAGS)
  set(OF24x_CXX_FLAGS "${OF24x_c++FLAGS} -DOF23x -DOF24x -DOF_VERSION=020400 -DOF_FORK_vanilla")
  set(OF24x_LIBSRC_DIR "${OF24x_DIR}/src")
  set(OF24x_LIB_DIR "${OF24x_DIR}/platforms/${OF24x_WM_OPTIONS}/lib")
  
  string(REGEX REPLACE "^[^ ]+" "" OF24x_LINKLIBSO ${OF24x_LINKLIBSO})
  string(REGEX REPLACE "^[^ ]+" "" OF24x_LINKEXE ${OF24x_LINKEXE})
...
randomProcesses
  ...
  set(OF24x_INSIGHT_INSTALL_BIN "bin/${OF24x_WM_PROJECT}-${OF24x_WM_PROJECT_VERSION}")
  set(OF24x_INSIGHT_INSTALL_LIB "lib/${OF24x_WM_PROJECT}-${OF24x_WM_PROJECT_VERSION}")
  set(OF24x_INSIGHT_BIN "${CMAKE_BINARY_DIR}/${OF24x_INSIGHT_INSTALL_BIN}")
  set(OF24x_INSIGHT_LIB "${CMAKE_BINARY_DIR}/${OF24x_INSIGHT_INSTALL_LIB}")
  ...
  macro (setup_exe_target_OF24x targetname sources exename includes)
    ...
    install(TARGETS ${targetname} RUNTIME DESTINATION ${OF24x_INSIGHT_INSTALL_BIN} COMPONENT ${INSIGHT_INSTALL_COMPONENT})
  ...
  macro (setup_lib_target_OF24x targetname sources exename includes)
    ...
    SET(LIB_SEARCHFLAGS "-L${OF24x_LIB_DIR} -L${OF24x_LIB_DIR}/${OF24x_FOAM_MPI} -L${OF24x_FOAM_EXT_LIBBIN} -L${OF24x_SCOTCH_ROOT}/lib")
    ...
    install(TARGETS ${targetname} LIBRARY DESTINATION ${OF24x_INSIGHT_INSTALL_LIB} COMPONENT ${INSIGHT_INSTALL_COMPONENT})
