...
std::unique_ptr<hierarchicalData::Element> PathParameter::doCloneUninitialized() const
{
...
std::unique_ptr<hierarchicalData::Element> DirectoryParameter::doCloneUninitialized() const
{
