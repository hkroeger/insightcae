...
IF(Fx31_BASHRC)
  ...
  filterWarningFlags(Fx31_c++FLAGS)

  set(Fx31_CXX_FLAGS "${Fx31_c++FLAGS} -DFx31 -DOF16ext -DOF_VERSION=010601 -DOF_FORK_extend")
...
detectDepLib(Fx31 "${Fx31_FOAM_LIBBIN}/libmesquiteMotionSolver.so" "mesquite")
  ...
  string(REGEX REPLACE "^[^ ]+" "" Fx31_LINKLIBSO ${Fx31_LINKLIBSO})
  string(REGEX REPLACE "^[^ ]+" "" Fx31_LINKEXE ${Fx31_LINKEXE})
