...
IMPLEMENT_STANDARD_RTTIEXT(STL_DataSource,MeshVS_DataSource)

//================================================================
// Function : Constructor
// Purpose  :
//================================================================
STL_DataSource::STL_DataSource (const Handle(Poly_Triangulation)& aMesh)
{
  myMesh = aMesh;
...
// Purpose  :
//================================================================
Standard_Boolean STL_DataSource::GetGeom
...
// Purpose  :
//================================================================
Standard_Boolean STL_DataSource::GetGeomType
...
// Purpose  :
//================================================================
Standard_Address STL_DataSource::GetAddr
...
// Purpose  :
//================================================================
Standard_Boolean STL_DataSource::GetNodesByElement
...
// Purpose  :
//================================================================
const TColStd_PackedMapOfInteger& STL_DataSource::GetAllNodes() const
{
  return myNodes;
}
...
// Purpose  :
//================================================================
const TColStd_PackedMapOfInteger& STL_DataSource::GetAllElements() const
{
  return myElements;
}
...
// Purpose  :
//================================================================
Standard_Boolean STL_DataSource::GetNormal
