...
IF(Fx32_BASHRC)
  ...
  filterWarningFlags(Fx32_c++FLAGS)

  set(Fx32_CXX_FLAGS "${Fx32_c++FLAGS} -DFx32 -DOF16ext -DOF_VERSION=010602 -DOF_FORK_extend")
  set(Fx32_LIBSRC_DIR "${Fx32_DIR}/src")
  set(Fx32_LIB_DIR "${Fx32_DIR}/platforms/${Fx32_WM_OPTIONS}/lib")
  
  string(REGEX REPLACE "^[^ ]+" "" Fx32_LINKLIBSO ${Fx32_LINKLIBSO})
  string(REGEX REPLACE "^[^ ]+" "" Fx32_LINKEXE ${Fx32_LINKEXE})
