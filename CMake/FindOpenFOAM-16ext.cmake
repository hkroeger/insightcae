...
IF(OF16ext_BASHRC)
  ...
  detectEnvVars(OF16ext
    WM_PROJECT WM_PROJECT_VERSION WM_OPTIONS
    METIS_LIB_DIR PARMETIS_LIB_DIR
    SCOTCH_LIB_DIR
    MESQUITE_LIB_DIR
    FOAM_MPI_LIBBIN
    FOAM_APPBIN
  ...
  filterWarningFlags(OF16ext_c++FLAGS)
  set(OF16ext_CXX_FLAGS "${OF16ext_c++FLAGS} -DOF16ext -DOF_VERSION=010600 -DOF_FORK_extend")
  ...
  string(REGEX REPLACE "^[^ ]+" "" OF16ext_LINKLIBSO ${OF16ext_LINKLIBSO})
  string(REGEX REPLACE "^[^ ]+" "" OF16ext_LINKEXE ${OF16ext_LINKEXE})
