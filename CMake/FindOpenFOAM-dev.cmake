...
randomProcesses
  ...
  set(OFdev_INSIGHT_INSTALL_BIN "bin/${OFdev_WM_PROJECT}-${OFdev_WM_PROJECT_VERSION}")
  set(OFdev_INSIGHT_INSTALL_LIB "lib/${OFdev_WM_PROJECT}-${OFdev_WM_PROJECT_VERSION}")
  set(OFdev_INSIGHT_BIN "${CMAKE_BINARY_DIR}/${OFdev_INSIGHT_INSTALL_BIN}")
  set(OFdev_INSIGHT_LIB "${CMAKE_BINARY_DIR}/${OFdev_INSIGHT_INSTALL_LIB}")
  ...
  macro (setup_exe_target_OFdev targetname sources exename includes)
    ...
    install(TARGETS ${targetname} RUNTIME DESTINATION ${OFdev_INSIGHT_INSTALL_BIN} COMPONENT ${INSIGHT_INSTALL_COMPONENT})
  ...
  macro (setup_lib_target_OFdev targetname sources exename includes)
    ...
    install(TARGETS ${targetname} LIBRARY DESTINATION ${OFdev_INSIGHT_INSTALL_LIB} COMPONENT ${INSIGHT_INSTALL_COMPONENT})
