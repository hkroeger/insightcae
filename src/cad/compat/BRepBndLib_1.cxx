                                    ...
                                    Bnd_OBB& theOBB)
{
  ...
  std::unique_ptr<TColStd_Array1OfReal> anArrOfTolerances;
  if(theIsShapeToleranceUsed)
  {
    anArrOfTolerances.reset(new TColStd_Array1OfReal(
                                anArrPnts.Lower(), anArrPnts.Upper(), Standard_False) );
    anArrOfTolerances->Init(0.0);
  }

  TColStd_Array1OfReal *aPtrArrTol = theIsShapeToleranceUsed ? anArrOfTolerances.get() : 0;
