...
#ifndef _STL_DataSource_HeaderFile
#define _STL_DataSource_HeaderFile
...
class STL_DataSource;
DEFINE_STANDARD_HANDLE(STL_DataSource, MeshVS_DataSource)

//! The sample DataSource for working with STLMesh_Mesh
class STL_DataSource : public MeshVS_DataSource
{
...
public:
  ...
  //! Constructor
  Standard_EXPORT STL_DataSource(const Handle(Poly_Triangulation)& aMesh);
  ...
  DEFINE_STANDARD_RTTIEXT(STL_DataSource,MeshVS_DataSource)
...
#endif // _STL_DataSource_HeaderFile
