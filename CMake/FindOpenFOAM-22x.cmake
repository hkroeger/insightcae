...
OpenFOAM
  ...
  set(OF22x_INSIGHT_INSTALL_BIN "bin/${OF22x_WM_PROJECT}-${OF22x_WM_PROJECT_VERSION}")
  set(OF22x_INSIGHT_INSTALL_LIB "lib/${OF22x_WM_PROJECT}-${OF22x_WM_PROJECT_VERSION}")
  set(OF22x_INSIGHT_BIN "${CMAKE_BINARY_DIR}/${OF22x_INSIGHT_INSTALL_BIN}")
  set(OF22x_INSIGHT_LIB "${CMAKE_BINARY_DIR}/${OF22x_INSIGHT_INSTALL_LIB}")
