...
void BGParsingThread::run()
{
  ...
  //                    v.second->value();
                  ...
                  for (const std::string& sn: removedScalars)
                  {
...

              {
                  ...
                  for (const std::string& sn: removedFeatures)
                  {
...

              {
                  ...
                  for (const std::string& sn: removedDatums)
                  {
...

              {
                  ...
                  for (const std::string& sn: removedPostprocActions)
                  {
