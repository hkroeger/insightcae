The files in this directory (Re180/balances) contain terms in the
...
Hoyas et al (2006) "Reynolds number effects in the Reynolds stress 
statistics and balances", J. of Fluid Mech, in preparation.

Before final publication of a paper citing this data, please check 
this site for an up-to-date reference.

This directory contains 5 files named Re180.bal.<extension>, where
...
There also are 5 files named Re180.std.<extension> containing the 
